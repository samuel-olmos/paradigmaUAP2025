...
var $author$project$Clase3$head = function (list) {
...
var $author$project$Clase3$agruparPor = F2(
	function (comparador, lista) {
		if (!lista.b) {
			...
			var head1 = lista.a;
			var tail1 = lista.b;
			var _v1 = A2($author$project$Clase3$agruparPor, comparador, tail1);
			if (!_v1.b) {
				return _List_fromArray(
					[
						_List_fromArray(
				...
				return A2(
					comparador,
					head1,
					$author$project$Clase3$head(head2)) ? A2(
					$elm$core$List$cons,
					A2($elm$core$List$cons, head1, head2),
					tail2) : A2(
					$elm$core$List$cons,
					_List_fromArray(
						[head1]),
					A2($elm$core$List$cons, head2, tail2));
			}
		}
	});
...
var $author$project$Clase3Test$testsAgruparPor = A2(
	$elm_explorations$test$Test$describe,
	'Tests para agruparPor',
	_List_fromArray(
		[
			A2(
			$elm_explorations$test$Test$test,
			'agrupar por igualdad',
			function (_v0) {
				return A2(
					...
					A2(
						$author$project$Clase3$agruparPor,
						$elm$core$Basics$eq,
						_List_fromArray(
							[1, 1, 2, 2, 3, 1])));
			}),
			...
			function (_v1) {
				return A2(
					$elm_explorations$test$Expect$equal,
					_List_Nil,
					A2($author$project$Clase3$agruparPor, $elm$core$Basics$eq, _List_Nil));
			})
		]));
var $author$project$Clase3$isEmpty = function (list) {
...
var $author$project$Clase3$tail = function (list) {
	return A2(
		$elm$core$Maybe$withDefault,
		_List_Nil,
		$elm$core$List$tail(list));
};
var $author$project$Clase3$miFoldl = F3(
	function (fx, acumulador, lista) {
		miFoldl:
		while (true) {
			if ($author$project$Clase3$isEmpty(lista)) {
				return acumulador;
			} else {
				var nuevoAcumulador = A2(
					fx,
					$author$project$Clase3$head(lista),
					acumulador);
				var $temp$fx = fx,
					$temp$acumulador = nuevoAcumulador,
					$temp$lista = $author$project$Clase3$tail(lista);
				fx = $temp$fx;
...
var $author$project$Clase3$alguno = F2(
	function (predicado, lista) {
		return A3(
			$author$project$Clase3$miFoldl,
			F2(
				function (elemento, acumulador) {
					return acumulador || predicado(elemento);
				}),
			false,
			lista);
	});
var $author$project$Clase3Test$testsAlguno = A2(
	$elm_explorations$test$Test$describe,
	'Tests para alguno',
	_List_fromArray(
		[
			A2(
			$elm_explorations$test$Test$test,
			'alguno mayor que 5 - True',
			function (_v0) {
				return A2(
					$elm_explorations$test$Expect$equal,
					true,
					A2(
						$author$project$Clase3$alguno,
						function (x) {
							return x > 5;
						},
						_List_fromArray(
...
var $author$project$Clase3$aplanar = function (lista) {
	return A3(
		$author$project$Clase3$miFoldl,
		F2(
			function (sublista, acumulador) {
				return _Utils_ap(acumulador, sublista);
			}),
		_List_Nil,
		lista);
};
var $author$project$Clase3Test$testsAplanar = A2(
	$elm_explorations$test$Test$describe,
	'Tests para aplanar',
	_List_fromArray(
		[
			A2(
			$elm_explorations$test$Test$test,
			'aplanar lista normal',
			function (_v0) {
				return A2(
					$elm_explorations$test$Expect$equal,
					_List_fromArray(
						[1, 2, 3, 4, 5]),
					$author$project$Clase3$aplanar(
						_List_fromArray(
							[
								_List_fromArray(
								[1, 2]),
			...
			function (_v1) {
				return A2(
					$elm_explorations$test$Expect$equal,
					_List_Nil,
					$author$project$Clase3$aplanar(_List_Nil));
			})
		]));
var $author$project$Clase3$concatenar = function (lista) {
	return A3(
		$author$project$Clase3$miFoldl,
		F2(
			function (elemento, acumulador) {
				return _Utils_ap(acumulador, elemento);
			}),
		'',
		lista);
};
var $author$project$Clase3Test$testsConcatenar = A2(
	$elm_explorations$test$Test$describe,
		...
		[
			...
			function (_v0) {
				return A2(
					$elm_explorations$test$Expect$equal,
					'Hola Mundo',
					$author$project$Clase3$concatenar(
						_List_fromArray(
							['Hola', ' ', 'Mundo'])));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'concatenar lista vacía',
			function (_v1) {
				return A2(
					$elm_explorations$test$Expect$equal,
					'',
					$author$project$Clase3$concatenar(_List_Nil));
			})
		]));
var $author$project$Clase3$contarFold = function (lista) {
	return A3(
		$author$project$Clase3$miFoldl,
		F2(
			function (elemento, acumulador) {
...
var $author$project$Clase3Test$testsContarFold = A2(
	$elm_explorations$test$Test$describe,
	'Tests para contarFold',
	_List_fromArray(
		[
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v0) {
				return A2(
					$elm_explorations$test$Expect$equal,
					3,
					$author$project$Clase3$contarFold(
						_List_fromArray(
							[1, 2, 3])));
			}),
			A2(
			...
			function (_v1) {
				return A2(
					$elm_explorations$test$Expect$equal,
					0,
					$author$project$Clase3$contarFold(_List_Nil));
			})
		]));
var $elm$core$Basics$modBy = _Basics_modBy;
var $author$project$Clase3$contarPares = function (lista) {
	return A3(
		$author$project$Clase3$miFoldl,
		F2(
			function (elemento, acumulador) {
				return (!A2($elm$core$Basics$modBy, 2, elemento)) ? (acumulador + 1) : acumulador;
			}),
		0,
		lista);
};
var $author$project$Clase3Test$testsContarPares = A2(
	$elm_explorations$test$Test$describe,
	...
	_List_fromArray(
		[
			A2(
			$elm_explorations$test$Test$test,
			'contar pares lista normal',
			function (_v0) {
				return A2(
					$elm_explorations$test$Expect$equal,
					2,
					$author$project$Clase3$contarPares(
						_List_fromArray(
							[1, 2, 3, 4, 5])));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'contar pares lista vacía',
			function (_v1) {
				return A2(
					$elm_explorations$test$Expect$equal,
					0,
					$author$project$Clase3$contarPares(_List_Nil));
			})
		]));
var $author$project$Clase3$saltar = F2(
	function (n, lista) {
		saltar:
		while (true) {
			if ($author$project$Clase3$isEmpty(lista)) {
...
var $author$project$Clase3$tomar = F2(
	function (n, lista) {
		return $author$project$Clase3$isEmpty(lista) ? _List_Nil : ((!n) ? _List_Nil : A2(
			$elm$core$List$cons,
			$author$project$Clase3$head(lista),
			A2(
				$author$project$Clase3$tomar,
				n - 1,
				$author$project$Clase3$tail(lista))));
	});
var $author$project$Clase3$cortar = F2(
	function (lista, n) {
		return $author$project$Clase3$isEmpty(lista) ? _List_Nil : A2(
			$elm$core$List$cons,
			A2($author$project$Clase3$tomar, n, lista),
			A2(
				$author$project$Clase3$cortar,
				A2($author$project$Clase3$saltar, n, lista),
				n));
	});
var $author$project$Clase3Test$testsCortar = A2(
	$elm_explorations$test$Test$describe,
		...
		[
			...
			function (_v2) {
				return A2(
					$elm_explorations$test$Expect$equal,
					_List_Nil,
					A2($author$project$Clase3$cortar, _List_Nil, 2));
			})
		]));
var $author$project$Clase3$miMap = F2(
	function (fx, lista) {
		return $author$project$Clase3$isEmpty(lista) ? _List_Nil : A2(
			$elm$core$List$cons,
			fx(
				$author$project$Clase3$head(lista)),
			A2(
				$author$project$Clase3$miMap,
				fx,
				$author$project$Clase3$tail(lista)));
	});
var $author$project$Clase3$duplicar = function (lista) {
	return A2(
		$author$project$Clase3$miMap,
		function (x) {
			return x * 2;
...
var $author$project$Clase3Test$testsDuplicar = A2(
	$elm_explorations$test$Test$describe,
	'Tests para duplicar',
	_List_fromArray(
		[
			A2(
			$elm_explorations$test$Test$test,
			'duplicar lista normal',
			function (_v0) {
				return A2(
					$elm_explorations$test$Expect$equal,
					_List_fromArray(
						[2, 4, 6]),
					$author$project$Clase3$duplicar(
						_List_fromArray(
							[1, 2, 3])));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'duplicar lista vacía',
			function (_v1) {
				return A2(
					$elm_explorations$test$Expect$equal,
					_List_Nil,
					$author$project$Clase3$duplicar(_List_Nil));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'duplicar con negativos',
			function (_v2) {
				return A2(
					$elm_explorations$test$Expect$equal,
					_List_fromArray(
...
var $author$project$Clase3$duplicarPares = function (lista) {
	return A2(
		$author$project$Clase3$miMap,
		function (x) {
			return (!A2($elm$core$Basics$modBy, 2, x)) ? (x * 2) : x;
		},
		lista);
};
var $author$project$Clase3Test$testsDuplicarPares = A2(
	$elm_explorations$test$Test$describe,
	'Tests para duplicarPares',
	_List_fromArray(
		[
			A2(
			$elm_explorations$test$Test$test,
			'duplicar pares lista normal',
			function (_v0) {
				return A2(
					$elm_explorations$test$Expect$equal,
					_List_fromArray(
						[1, 4, 3, 8]),
					$author$project$Clase3$duplicarPares(
						_List_fromArray(
							[1, 2, 3, 4])));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'duplicar pares lista vacía',
			function (_v1) {
				return A2(
					$elm_explorations$test$Expect$equal,
					_List_Nil,
					$author$project$Clase3$duplicarPares(_List_Nil));
			})
		]));
var $author$project$Clase3$incrementarTodos = function (lista) {
	return A2(
		$author$project$Clase3$miMap,
		function (x) {
			return x + 1;
...
var $author$project$Clase3Test$testsIncrementarTodos = A2(
	$elm_explorations$test$Test$describe,
	'Tests para incrementarTodos',
	_List_fromArray(
		[
			A2(
			$elm_explorations$test$Test$test,
			'incrementar lista normal',
			function (_v0) {
				return A2(
					$elm_explorations$test$Expect$equal,
					_List_fromArray(
						[2, 3, 4]),
					$author$project$Clase3$incrementarTodos(
						_List_fromArray(
							[1, 2, 3])));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'incrementar lista vacía',
			function (_v1) {
				return A2(
					$elm_explorations$test$Expect$equal,
					_List_Nil,
					$author$project$Clase3$incrementarTodos(_List_Nil));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'incrementar con negativos',
			function (_v2) {
				return A2(
					$elm_explorations$test$Expect$equal,
					_List_fromArray(
...
var $author$project$Clase3$invertirFold = function (lista) {
	return A3(
		$author$project$Clase3$miFoldl,
		F2(
			function (elemento, acumulador) {
				return A2($elm$core$List$cons, elemento, acumulador);
			}),
		_List_Nil,
		lista);
};
var $author$project$Clase3Test$testsInvertirFold = A2(
	$elm_explorations$test$Test$describe,
	'Tests para invertirFold',
	_List_fromArray(
		[
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v0) {
				return A2(
					...
					_List_fromArray(
						[3, 2, 1]),
					$author$project$Clase3$invertirFold(
						_List_fromArray(
							[1, 2, 3])));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'invertir lista vacía',
			function (_v1) {
				return A2(
					$elm_explorations$test$Expect$equal,
					_List_Nil,
					$author$project$Clase3$invertirFold(_List_Nil));
			})
		]));
var $author$project$Clase3$longitudes = function (lista) {
	return A2(
		$author$project$Clase3$miMap,
		function (s) {
...
var $author$project$Clase3Test$testsLongitudes = A2(
	$elm_explorations$test$Test$describe,
	'Tests para longitudes',
	_List_fromArray(
		[
			A2(
			$elm_explorations$test$Test$test,
			'longitudes lista normal',
			function (_v0) {
				return A2(
					$elm_explorations$test$Expect$equal,
					_List_fromArray(
						[4, 4]),
					$author$project$Clase3$longitudes(
						_List_fromArray(
							['hola', 'chau'])));
			}),
			A2(
			...
			function (_v1) {
				return A2(
					$elm_explorations$test$Expect$equal,
					_List_Nil,
					$author$project$Clase3$longitudes(_List_Nil));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'longitudes strings vacíos',
			function (_v2) {
				return A2(
					$elm_explorations$test$Expect$equal,
					_List_fromArray(
...
var $author$project$Clase3$longitudesPalabras = function (oracion) {
	return A3(
		$author$project$Clase3$miFoldl,
		F2(
			function (palabra, acumulador) {
				return _Utils_ap(
					acumulador,
					_List_fromArray(
						[
							$elm$core$String$length(palabra)
						]));
			}),
		_List_Nil,
		$elm$core$String$words(oracion));
};
var $author$project$Clase3Test$testsLongitudesPalabras = A2(
	$elm_explorations$test$Test$describe,
	'Tests para longitudesPalabras',
	_List_fromArray(
		[
			A2(
			$elm_explorations$test$Test$test,
			'longitudes de palabras normal',
			function (_v0) {
				return A2(
					$elm_explorations$test$Expect$equal,
					_List_fromArray(
						[4, 5]),
					$author$project$Clase3$longitudesPalabras('hola mundo'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'longitudes de palabras vacío',
			function (_v1) {
				return A2(
					$elm_explorations$test$Expect$equal,
					_List_fromArray(
						[0]),
					$author$project$Clase3$longitudesPalabras(''));
			})
		]));
var $author$project$Clase3$maximo = function (lista) {
	return A3(
		$author$project$Clase3$miFoldl,
		F2(
			function (elemento, acumulador) {
				return (_Utils_cmp(elemento, acumulador) > 0) ? elemento : acumulador;
			}),
		0,
		lista);
};
var $author$project$Clase3Test$testsMaximo = A2(
	$elm_explorations$test$Test$describe,
	'Tests para maximo',
	_List_fromArray(
		[
			...
			function (_v1) {
				return A2(
					$elm_explorations$test$Expect$equal,
					0,
					$author$project$Clase3$maximo(_List_Nil));
			})
		]));
var $author$project$Clase3$miFiltro = F2(
	function (predicado, lista) {
		miFiltro:
		while (true) {
			if ($author$project$Clase3$isEmpty(lista)) {
				...
				var h = $author$project$Clase3$head(lista);
				if (predicado(h)) {
					return A2(
						$elm$core$List$cons,
						h,
						A2(
							$author$project$Clase3$miFiltro,
							predicado,
							$author$project$Clase3$tail(lista)));
				} else {
...
var $author$project$Clase3$mayoresQue = F2(
	function (valor, lista) {
		return A2(
			$author$project$Clase3$miFiltro,
			function (x) {
				return _Utils_cmp(x, valor) > 0;
			},
			lista);
	});
var $author$project$Clase3Test$testsMayoresQue = A2(
	$elm_explorations$test$Test$describe,
	'Tests para mayoresQue',
	_List_fromArray(
		[
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v0) {
				return A2(
					...
					_List_fromArray(
						[4, 5]),
					A2(
						$author$project$Clase3$mayoresQue,
						3,
						_List_fromArray(
							[1, 2, 3, 4, 5])));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'mayores que con lista vacía',
			function (_v1) {
				return A2(
					$elm_explorations$test$Expect$equal,
					_List_Nil,
					A2($author$project$Clase3$mayoresQue, 3, _List_Nil));
			})
		]));
var $author$project$Clase3Test$testsMiFiltro = A2(
	$elm_explorations$test$Test$describe,
	'Tests para miFiltro',
	_List_fromArray(
		[
...
var $author$project$Clase3Test$testsMiFoldl = A2(
	$elm_explorations$test$Test$describe,
	'Tests para miFoldl',
	_List_fromArray(
		[
			...
			A2(
			$elm_explorations$test$Test$test,
			'miFoldl con lista vacía',
			function (_v1) {
				return A2(
					$elm_explorations$test$Expect$equal,
					0,
					A3($author$project$Clase3$miFoldl, $elm$core$Basics$add, 0, _List_Nil));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'miFoldl multiplicación',
			function (_v2) {
				return A2(
					$elm_explorations$test$Expect$equal,
					24,
...
var $author$project$Clase3Test$testsMiMap = A2(
	$elm_explorations$test$Test$describe,
	'Tests para miMap',
	_List_fromArray(
		[
...
var $author$project$Clase3$negarTodos = function (lista) {
	return A2(
		$author$project$Clase3$miMap,
		function (b) {
			return !b;
...
var $author$project$Clase3Test$testsNegarTodos = A2(
	$elm_explorations$test$Test$describe,
	'Tests para negarTodos',
	_List_fromArray(
		[
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v0) {
				return A2(
					...
					_List_fromArray(
						[false, true, false]),
					$author$project$Clase3$negarTodos(
						_List_fromArray(
							[true, false, true])));
			}),
			A2(
			...
			function (_v1) {
				return A2(
					$elm_explorations$test$Expect$equal,
					_List_Nil,
					$author$project$Clase3$negarTodos(_List_Nil));
			})
		]));
var $author$project$Clase3$palabrasLargas = function (oracion) {
	return A2(
		$author$project$Clase3$miFiltro,
		function (palabra) {
			return $author$project$Clase3$contarFold(
				$elm$core$String$toList(palabra)) > 3;
		},
		$elm$core$String$words(oracion));
};
var $author$project$Clase3Test$testsPalabrasLargas = A2(
	$elm_explorations$test$Test$describe,
	'Tests para palabrasLargas',
	_List_fromArray(
		[
			A2(
			$elm_explorations$test$Test$test,
			'palabras largas normal',
			function (_v0) {
				return A2(
					$elm_explorations$test$Expect$equal,
					_List_fromArray(
						['estoy', 'aprendiendo']),
					$author$project$Clase3$palabrasLargas('Yo estoy aprendiendo Elm'));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'palabras largas sin coincidencias',
			function (_v1) {
				return A2(
					$elm_explorations$test$Expect$equal,
					_List_Nil,
					$author$project$Clase3$palabrasLargas('Yo soy un'));
			})
		]));
var $author$project$Clase3$pares = function (lista) {
	return A2(
		$author$project$Clase3$miFiltro,
		function (x) {
			return !A2($elm$core$Basics$modBy, 2, x);
...
var $author$project$Clase3Test$testsPares = A2(
	$elm_explorations$test$Test$describe,
	'Tests para pares',
	_List_fromArray(
		[
			...
			function (_v1) {
				return A2(
					$elm_explorations$test$Expect$equal,
					_List_Nil,
					$author$project$Clase3$pares(_List_Nil));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'pares sin elementos',
...
var $author$project$Clase3$particionar = F2(
	function (predicado, lista) {
		return _Utils_Tuple2(
			A2($author$project$Clase3$miFiltro, predicado, lista),
			A2(
				$author$project$Clase3$miFiltro,
				function (x) {
					return !predicado(x);
...
var $author$project$Clase3Test$testsParticionar = A2(
	$elm_explorations$test$Test$describe,
	'Tests para particionar',
	_List_fromArray(
		[
			A2(
			$elm_explorations$test$Test$test,
			'particionar mayores que 3',
			function (_v0) {
				return A2(
					$elm_explorations$test$Expect$equal,
					_Utils_Tuple2(
						...
						_List_fromArray(
							[1, 2, 3])),
					A2(
						$author$project$Clase3$particionar,
						function (x) {
							return x > 3;
						},
						_List_fromArray(
...
var $author$project$Clase3$positivos = function (lista) {
	return A2(
		$author$project$Clase3$miFiltro,
		function (x) {
			return x > 0;
...
var $author$project$Clase3Test$testsPositivos = A2(
	$elm_explorations$test$Test$describe,
	'Tests para positivos',
	_List_fromArray(
		[
			A2(
			$elm_explorations$test$Test$test,
			'positivos lista normal',
			function (_v0) {
				return A2(
					$elm_explorations$test$Expect$equal,
					_List_fromArray(
						[2, 4]),
					$author$project$Clase3$positivos(
						_List_fromArray(
							[-1, 2, -3, 4])));
			}),
			A2(
			...
			function (_v1) {
				return A2(
					$elm_explorations$test$Expect$equal,
					_List_Nil,
					$author$project$Clase3$positivos(_List_Nil));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'positivos todos negativos',
			function (_v2) {
				return A2(
					$elm_explorations$test$Expect$equal,
					_List_Nil,
...
var $author$project$Clase3$producto = function (lista) {
	return A3(
		$author$project$Clase3$miFoldl,
		F2(
			function (elemento, acumulador) {
...
var $author$project$Clase3Test$testsProducto = A2(
	$elm_explorations$test$Test$describe,
	'Tests para producto',
	_List_fromArray(
		[
			A2(
			$elm_explorations$test$Test$test,
			'producto lista normal',
			function (_v0) {
				return A2(
					$elm_explorations$test$Expect$equal,
					24,
					$author$project$Clase3$producto(
						_List_fromArray(
							[2, 3, 4])));
			}),
			A2(
...
var $author$project$Clase3$promedio = function (lista) {
	return $author$project$Clase3$isEmpty(lista) ? 0 : (A3(
		$author$project$Clase3$miFoldl,
		F2(
			function (elemento, acumulador) {
				return acumulador + elemento;
...
var $author$project$Clase3Test$testsPromedio = A2(
	$elm_explorations$test$Test$describe,
	'Tests para promedio',
	_List_fromArray(
		[
			A2(
			$elm_explorations$test$Test$test,
			'promedio lista normal',
			function (_v0) {
				return A3(
					$elm_explorations$test$Expect$within,
					$elm_explorations$test$Expect$Absolute(0.01),
					2.0,
					$author$project$Clase3$promedio(
						_List_fromArray(
							[1.0, 2.0, 3.0])));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'promedio lista vacía',
			function (_v1) {
				return A2(
					$elm_explorations$test$Expect$equal,
					0,
					$author$project$Clase3$promedio(_List_Nil));
			})
		]));
var $author$project$Clase3$soloVerdaderos = function (lista) {
	return A2(
		$author$project$Clase3$miFiltro,
		function (b) {
			return b;
...
var $author$project$Clase3Test$testsSoloVerdaderos = A2(
	$elm_explorations$test$Test$describe,
	'Tests para soloVerdaderos',
	_List_fromArray(
		[
			A2(
			$elm_explorations$test$Test$test,
			'solo verdaderos lista normal',
			function (_v0) {
				return A2(
					$elm_explorations$test$Expect$equal,
					_List_fromArray(
						[true, true]),
					$author$project$Clase3$soloVerdaderos(
						_List_fromArray(
							[true, false, true])));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'solo verdaderos lista vacía',
			function (_v1) {
				return A2(
					$elm_explorations$test$Expect$equal,
					_List_Nil,
					$author$project$Clase3$soloVerdaderos(_List_Nil));
			})
		]));
var $author$project$Clase3$stringsLargos = function (lista) {
	return A2(
		$author$project$Clase3$miFiltro,
		function (palabra) {
			return $elm$core$String$length(palabra) > 4;
		},
		lista);
};
var $author$project$Clase3Test$testsStringsLargos = A2(
	$elm_explorations$test$Test$describe,
	'Tests para stringsLargos',
	_List_fromArray(
		[
			A2(
			$elm_explorations$test$Test$test,
			'strings largos lista normal',
			function (_v0) {
				return A2(
					$elm_explorations$test$Expect$equal,
					_List_fromArray(
						['buenos dias', 'mundo']),
					$author$project$Clase3$stringsLargos(
						_List_fromArray(
							['hola', 'buenos dias', 'mundo'])));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'strings largos lista vacía',
			function (_v1) {
				return A2(
					$elm_explorations$test$Expect$equal,
					_List_Nil,
					$author$project$Clase3$stringsLargos(_List_Nil));
			})
		]));
var $author$project$Clase3$subSets = function (lista) {
	if (!lista.b) {
		return _List_fromArray(
			[_List_Nil]);
	} else {
		var head1 = lista.a;
		var tail1 = lista.b;
		var subsetsSinX = $author$project$Clase3$subSets(tail1);
		var subsetsConX = A2(
			$author$project$Clase3$miMap,
			function (subset) {
				return A2($elm$core$List$cons, head1, subset);
			},
			subsetsSinX);
		return _Utils_ap(subsetsSinX, subsetsConX);
	}
};
var $author$project$Clase3Test$testsSubSets = A2(
	$elm_explorations$test$Test$describe,
	...
	_List_fromArray(
		[
			A2(
			$elm_explorations$test$Test$test,
			'subsets de lista vacía',
			function (_v0) {
				return A2(
					$elm_explorations$test$Expect$equal,
					_List_fromArray(
						[_List_Nil]),
					$author$project$Clase3$subSets(_List_Nil));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'subsets de un elemento - cantidad',
			function (_v1) {
				return A2(
					$elm_explorations$test$Expect$equal,
					2,
					$elm$core$List$length(
						$author$project$Clase3$subSets(
							_List_fromArray(
								[1]))));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'subsets de dos elementos - cantidad',
			function (_v2) {
				return A2(
					$elm_explorations$test$Expect$equal,
					4,
			...
			A2(
			$elm_explorations$test$Test$test,
			'subsets de tres elementos - cantidad',
			function (_v3) {
				return A2(
					$elm_explorations$test$Expect$equal,
					8,
...
var $author$project$Clase3$sumaAcumulada = function (lista) {
	if (!lista.b) {
		return _List_Nil;
	} else {
		var h = lista.a;
			...
			A3(
				...
				F2(
					function (x, acc) {
						return A2(
							$elm$core$List$cons,
							$author$project$Clase3$head(acc) + x,
							acc);
					}),
				_List_fromArray(
					[h]),
...
var $author$project$Clase3Test$testsSumaAcumulada = A2(
	$elm_explorations$test$Test$describe,
	'Tests para sumaAcumulada',
	_List_fromArray(
		[
			A2(
			$elm_explorations$test$Test$test,
			'suma acumulada lista normal',
			function (_v0) {
				return A2(
					$elm_explorations$test$Expect$equal,
					_List_fromArray(
						[1, 3, 6, 10]),
					$author$project$Clase3$sumaAcumulada(
						_List_fromArray(
							[1, 2, 3, 4])));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'suma acumulada lista vacía',
			function (_v1) {
				return A2(
					$elm_explorations$test$Expect$equal,
					_List_Nil,
					$author$project$Clase3$sumaAcumulada(_List_Nil));
			})
		]));
var $author$project$Clase3$sumaDeCuadrados = function (lista) {
	return A3(
		$author$project$Clase3$miFoldl,
		F2(
			function (elemento, acumulador) {
				return acumulador + (elemento * elemento);
			}),
		0,
		lista);
};
var $author$project$Clase3Test$testsSumaDeCuadrados = A2(
	$elm_explorations$test$Test$describe,
	'Tests para sumaDeCuadrados',
	_List_fromArray(
		[
			A2(
			$elm_explorations$test$Test$test,
			...
			function (_v0) {
				return A2(
					$elm_explorations$test$Expect$equal,
					14,
					$author$project$Clase3$sumaDeCuadrados(
						_List_fromArray(
							[1, 2, 3])));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'suma de cuadrados lista vacía',
			function (_v1) {
				return A2(
					$elm_explorations$test$Expect$equal,
					0,
					$author$project$Clase3$sumaDeCuadrados(_List_Nil));
			})
		]));
var $author$project$Clase3$sumaFold = function (lista) {
	return A3(
		$author$project$Clase3$miFoldl,
		F2(
			function (elemento, acumulador) {
...
var $author$project$Clase3Test$testsSumaFold = A2(
	$elm_explorations$test$Test$describe,
	'Tests para sumaFold',
	_List_fromArray(
		[
			...
			function (_v0) {
				return A2(
					$elm_explorations$test$Expect$equal,
					10,
					$author$project$Clase3$sumaFold(
						_List_fromArray(
							[1, 2, 3, 4])));
			}),
			A2(
			...
			function (_v1) {
				return A2(
					$elm_explorations$test$Expect$equal,
					0,
					$author$project$Clase3$sumaFold(_List_Nil));
			})
		]));
var $author$project$Clase3$sumarPositivos = function (lista) {
	return A3(
		$author$project$Clase3$miFoldl,
		F2(
			function (elemento, acumulador) {
				return (elemento > 0) ? (acumulador + elemento) : acumulador;
			}),
		0,
		lista);
};
var $author$project$Clase3Test$testsSumarPositivos = A2(
	$elm_explorations$test$Test$describe,
	'Tests para sumarPositivos',
	_List_fromArray(
		[
			A2(
			$elm_explorations$test$Test$test,
			'sumar positivos lista normal',
			function (_v0) {
				return A2(
					$elm_explorations$test$Expect$equal,
					9,
					$author$project$Clase3$sumarPositivos(
						_List_fromArray(
							[1, -2, 3, -4, 5])));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'sumar positivos lista vacía',
			function (_v1) {
				return A2(
					$elm_explorations$test$Expect$equal,
					0,
					$author$project$Clase3$sumarPositivos(_List_Nil));
			})
		]));
var $elm$core$String$toUpper = _String_toUpper;
var $author$project$Clase3$todasMayusculas = function (lista) {
	return A2(
		$author$project$Clase3$miMap,
		function (s) {
			return $elm$core$String$toUpper(s);
		},
		lista);
};
var $author$project$Clase3Test$testsTodasMayusculas = A2(
	$elm_explorations$test$Test$describe,
	'Tests para todasMayusculas',
	_List_fromArray(
		[
			A2(
			$elm_explorations$test$Test$test,
			'todas mayúsculas lista normal',
			function (_v0) {
				return A2(
					$elm_explorations$test$Expect$equal,
					_List_fromArray(
						['HOLA', 'CHAU']),
					$author$project$Clase3$todasMayusculas(
						_List_fromArray(
							['hola', 'chau'])));
			}),
			A2(
			$elm_explorations$test$Test$test,
			'todas mayúsculas lista vacía',
			function (_v1) {
				return A2(
					$elm_explorations$test$Expect$equal,
					_List_Nil,
					$author$project$Clase3$todasMayusculas(_List_Nil));
			})
		]));
var $author$project$Clase3$todos = F2(
	function (predicado, lista) {
		return A3(
			$author$project$Clase3$miFoldl,
			F2(
...
var $author$project$Clase3Test$testsTodos = A2(
	$elm_explorations$test$Test$describe,
	'Tests para todos',
	_List_fromArray(
		[
...
var $author$project$Clase3Test$suite = A2(
	$elm_explorations$test$Test$describe,
	'Suite completa de tests para Clase3',
	_List_fromArray(
		[$author$project$Clase3Test$testsMiMap, $author$project$Clase3Test$testsMiFiltro, $author$project$Clase3Test$testsMiFoldl, $author$project$Clase3Test$testsDuplicar, $author$project$Clase3Test$testsLongitudes, $author$project$Clase3Test$testsIncrementarTodos, $author$project$Clase3Test$testsTodasMayusculas, $author$project$Clase3Test$testsNegarTodos, $author$project$Clase3Test$testsPares, $author$project$Clase3Test$testsPositivos, $author$project$Clase3Test$testsStringsLargos, $author$project$Clase3Test$testsSoloVerdaderos, $author$project$Clase3Test$testsMayoresQue, $author$project$Clase3Test$testsSumaFold, $author$project$Clase3Test$testsProducto, $author$project$Clase3Test$testsContarFold, $author$project$Clase3Test$testsConcatenar, $author$project$Clase3Test$testsMaximo, $author$project$Clase3Test$testsInvertirFold, $author$project$Clase3Test$testsTodos, $author$project$Clase3Test$testsAlguno, $author$project$Clase3Test$testsSumaDeCuadrados, $author$project$Clase3Test$testsContarPares, $author$project$Clase3Test$testsPromedio, $author$project$Clase3Test$testsLongitudesPalabras, $author$project$Clase3Test$testsPalabrasLargas, $author$project$Clase3Test$testsSumarPositivos, $author$project$Clase3Test$testsDuplicarPares, $author$project$Clase3Test$testsAplanar, $author$project$Clase3Test$testsAgruparPor, $author$project$Clase3Test$testsParticionar, $author$project$Clase3Test$testsSumaAcumulada, $author$project$Clase3Test$testsSubSets, $author$project$Clase3Test$testsCortar]));
var $author$project$Test$Generated$Main$main = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$author$project$Test$Runner$Node$check($author$project$Clase3Test$testsMiMap),
					$author$project$Test$Runner$Node$check($author$project$Clase3Test$testsMiFiltro),
					$author$project$Test$Runner$Node$check($author$project$Clase3Test$testsMiFoldl),
					$author$project$Test$Runner$Node$check($author$project$Clase3Test$testsDuplicar),
					$author$project$Test$Runner$Node$check($author$project$Clase3Test$testsLongitudes),
					$author$project$Test$Runner$Node$check($author$project$Clase3Test$testsIncrementarTodos),
					$author$project$Test$Runner$Node$check($author$project$Clase3Test$testsTodasMayusculas),
					$author$project$Test$Runner$Node$check($author$project$Clase3Test$testsNegarTodos),
					$author$project$Test$Runner$Node$check($author$project$Clase3Test$testsPares),
					$author$project$Test$Runner$Node$check($author$project$Clase3Test$testsPositivos),
					$author$project$Test$Runner$Node$check($author$project$Clase3Test$testsStringsLargos),
					$author$project$Test$Runner$Node$check($author$project$Clase3Test$testsSoloVerdaderos),
					$author$project$Test$Runner$Node$check($author$project$Clase3Test$testsMayoresQue),
					$author$project$Test$Runner$Node$check($author$project$Clase3Test$testsSumaFold),
					$author$project$Test$Runner$Node$check($author$project$Clase3Test$testsProducto),
					$author$project$Test$Runner$Node$check($author$project$Clase3Test$testsContarFold),
					$author$project$Test$Runner$Node$check($author$project$Clase3Test$testsConcatenar),
					$author$project$Test$Runner$Node$check($author$project$Clase3Test$testsMaximo),
					$author$project$Test$Runner$Node$check($author$project$Clase3Test$testsInvertirFold),
					$author$project$Test$Runner$Node$check($author$project$Clase3Test$testsTodos),
					$author$project$Test$Runner$Node$check($author$project$Clase3Test$testsAlguno),
					$author$project$Test$Runner$Node$check($author$project$Clase3Test$testsSumaDeCuadrados),
					$author$project$Test$Runner$Node$check($author$project$Clase3Test$testsContarPares),
					$author$project$Test$Runner$Node$check($author$project$Clase3Test$testsPromedio),
					$author$project$Test$Runner$Node$check($author$project$Clase3Test$testsLongitudesPalabras),
					$author$project$Test$Runner$Node$check($author$project$Clase3Test$testsPalabrasLargas),
					$author$project$Test$Runner$Node$check($author$project$Clase3Test$testsSumarPositivos),
					$author$project$Test$Runner$Node$check($author$project$Clase3Test$testsDuplicarPares),
					$author$project$Test$Runner$Node$check($author$project$Clase3Test$testsAplanar),
					$author$project$Test$Runner$Node$check($author$project$Clase3Test$testsAgruparPor),
					$author$project$Test$Runner$Node$check($author$project$Clase3Test$testsParticionar),
					$author$project$Test$Runner$Node$check($author$project$Clase3Test$testsSumaAcumulada),
					$author$project$Test$Runner$Node$check($author$project$Clase3Test$testsSubSets),
					$author$project$Test$Runner$Node$check($author$project$Clase3Test$testsCortar),
					$author$project$Test$Runner$Node$check($author$project$Clase3Test$suite)
				]))
		]));
_Platform_export({'Test':{'Generated':{'Main':{'init':$author$project$Test$Generated$Main$main($elm$json$Json$Decode$int)(0)}}}});}(this));
return this.Elm;
})({});
var pipeFilename = "\\\\.\\pipe\\elm_test-10732-1";
var net = require('net'),
